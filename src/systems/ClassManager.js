...
export const CHARACTER_CLASSES = {
  ...
  ARCHER: {
    ...
    icon: '🏹',
    modelPath: 'assets/models/archer_torso.obj',
    mtlPath: 'assets/models/archer.mtl',
    isMultiPart: true,
    parts: {
      torso: { model: 'assets/models/archer_torso.obj', mtl: 'assets/models/archer.mtl' },
      armR: { model: 'assets/models/archer_arm_r.obj', mtl: 'assets/models/archer.mtl' },
      armL: { model: 'assets/models/archer_arm_l.obj', mtl: 'assets/models/archer.mtl' },
      legR: { model: 'assets/models/archer_leg_r.obj', mtl: 'assets/models/archer.mtl' },
      legL: { model: 'assets/models/archer_leg_l.obj', mtl: 'assets/models/archer.mtl' }
    },
  ...
  MAGE: {
    ...
    icon: '🧙',
    color: '#bb44ff',
    modelPath: 'assets/models/mage_torso.obj',
    mtlPath: 'assets/models/mage.mtl',
    isMultiPart: true,
    parts: {
      torso: { model: 'assets/models/mage_torso.obj', mtl: 'assets/models/mage.mtl' },
      armR: { model: 'assets/models/mage_arm_r.obj', mtl: 'assets/models/mage.mtl' },
      armL: { model: 'assets/models/mage_arm_l.obj', mtl: 'assets/models/mage.mtl' },
      legR: { model: 'assets/models/mage_leg_r.obj', mtl: 'assets/models/mage.mtl' },
      legL: { model: 'assets/models/mage_leg_l.obj', mtl: 'assets/models/mage.mtl' }
    },
  ...
  SPACEMARINE: {
    ...
    icon: '⚔️',
    color: '#ff3300',
    modelPath: 'assets/models/spacemarine_torso.obj',
    mtlPath: 'assets/models/spacemarine.mtl',
    isMultiPart: true,
    parts: {
      torso: { model: 'assets/models/spacemarine_torso.obj', mtl: 'assets/models/spacemarine.mtl' },
      armR: { model: 'assets/models/spacemarine_arm_r.obj', mtl: 'assets/models/spacemarine.mtl' },
      armL: { model: 'assets/models/spacemarine_arm_l.obj', mtl: 'assets/models/spacemarine.mtl' },
      legR: { model: 'assets/models/spacemarine_leg_r.obj', mtl: 'assets/models/spacemarine.mtl' },
      legL: { model: 'assets/models/spacemarine_leg_l.obj', mtl: 'assets/models/spacemarine.mtl' }
    },
    weaponModel: 'assets/models/relic_sword.obj',
  ...
  REAPER: {
    ...
    icon: '💀',
    color: '#00ffee',
    modelPath: 'assets/models/reaper_torso.obj',
    mtlPath: 'assets/models/reaper.mtl',
    isMultiPart: true,
    parts: {
      torso: { model: 'assets/models/reaper_torso.obj', mtl: 'assets/models/reaper.mtl' },
      armR: { model: 'assets/models/reaper_arm_r.obj', mtl: 'assets/models/reaper.mtl' },
      armL: { model: 'assets/models/reaper_arm_l.obj', mtl: 'assets/models/reaper.mtl' },
      legR: { model: 'assets/models/reaper_leg_r.obj', mtl: 'assets/models/reaper.mtl' },
      legL: { model: 'assets/models/reaper_leg_l.obj', mtl: 'assets/models/reaper.mtl' }
    },
    weaponModel: 'assets/models/scythe.obj',
    weaponMtl: 'assets/models/scythe.mtl',
    maxHp: 95,
    maxStamina: 105,
    moveSpeed: 10.2,
    baseDamage: 46,
  ...
  NECROMANCER: {
    ...
    icon: '🧟',
    color: '#00ff66',
    modelPath: 'assets/models/necro_torso.obj',
    mtlPath: 'assets/models/necromancer.mtl',
    isMultiPart: true,
    parts: {
      torso: { model: 'assets/models/necro_torso.obj', mtl: 'assets/models/necromancer.mtl' },
      armR: { model: 'assets/models/necro_arm_r.obj', mtl: 'assets/models/necromancer.mtl' },
      armL: { model: 'assets/models/necro_arm_l.obj', mtl: 'assets/models/necromancer.mtl' },
      legR: { model: 'assets/models/necro_leg_r.obj', mtl: 'assets/models/necromancer.mtl' },
      legL: { model: 'assets/models/necro_leg_l.obj', mtl: 'assets/models/necromancer.mtl' }
    },
